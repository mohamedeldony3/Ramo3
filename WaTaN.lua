...
local UserName = (data.username_ or "Remove44")
...
if text == '/start' then  
local url,res = https.request('https://abbas.Remove44.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Remove44 ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @Remove44')   
return false 
end
...
os.execute('rm -rf WaTaN.lua')
os.execute('wget https://raw.githubusercontent.com/Remove44/WaTaN/main/WaTaN.lua')
...
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙ان كان لديك استفسار او اي مشكلة\n✯︙يمكنك مراسلة مطور السورس\n✯︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/Ramo44)')
end

if text == 'تحديث المتجر ✯' and DevWaTaN(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Remove44/Files_Watan/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Remove44/Files_Watan/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Remove44/Files_Watan/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/Remove44)')
dofile('WaTaN.lua')  
end
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/Remove44"}},
}
...
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'Remove44')..')'
status  = '\n✯︙تم ترقيته مطور'
...
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Remove44')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if WaTaN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Remove44')..') \n✯︙'..WaTaN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/Remove44)}\n✯︙["..WaTaN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/Remove44)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = "[⦑ Welcome to Source ⦒](t.me/Remove44)\n[✯ ⦑ SOURCE WaTaN ⦒](t.me/Remove44)\n✯ Source version : 2.7"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/Remove44"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/watanupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/Remove44/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/joinchat/MJjy8Vab_jVmODdi"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/Ramo44"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Remove44&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Remove44')..') \n✯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Remove44')..') \n✯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevWaTaN(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Remove44/Files_Watan/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات وطن\n✯︙ملفات السورس ↓\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس وطن ↓\n".." ✯︙[اضغط هنا لدخول](t.me/Remove44) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Remove44/Files_Watan/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Remove44')..')'
status  = '\n✯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✯︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Remove44')..')'
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or Remove44}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/Remove44"}},
}
...
if text == "مبرمج السورس" or text == "المبرمج" or text == "مطور السورس" or text == "وين المبرمج" then
Text = [[
  ✯︙[DeVeLoPErE OF SoURcE](https://t.me/Ramo44)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙DeVeLoPErE OF SoURcE',url="t.me/Ramo44"}},
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/Remove44"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Remove44&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/Remove44)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/Remove44"}},
...
{{text = 'WaTaN TeaM .', url="t.me/Remove44"}},
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Remove44')..')'..'\n✯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ("مسح نقاطه") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if text and text:match("^مسح نقاطه @(.*)$") and BasicConstructor(msg) then
...
if text and text:match("^مسح نقاطه (%d+)$") and BasicConstructor(msg) then
...
if text == ("مسح رسائله") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if text and text:match("^مسح رسائله @(.*)$") and BasicConstructor(msg) then
...
if text and text:match("^مسح رسائله (%d+)$") and BasicConstructor(msg) then
...
if text == 'تفعيل الوضع المدفوع' and DevWaTaN(msg) then  
...
if text == 'تعطيل الوضع المدفوع' and DevWaTaN(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,WaTaN) 
if database:sismember(bot_id..'WaTaN:ProGroups',msg.chat_id_) then
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevWaTaN(msg) then
local List = database:smembers(bot_id.."WaTaN:ProGroups")
local WaTaN = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n'
for k,v in pairs(List) do
local WaTaNgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/Remove44"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Remove44:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."Remove44:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Remove44:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Remove44:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Remove44:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Remove44:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Remove44')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝐖𝐀𝐓𝐀𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Remove44"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
local Remove44 = database:get(bot_id.."WaTaN1:Add:Filter:Rp2"..text..result.chat_id_)   
if Remove44 then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..Remove44.."] \n") 
